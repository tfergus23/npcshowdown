...
public:
    ...
    size_t saveBattle(const Trainer& trainer1, const Trainer& trainer2, size_t seed, size_t user, size_t tournament);
    size_t saveBattle(const BattleResult result, size_t user, size_t tournament); //TODO: Why is this not a reference?
    void saveTournament(const Tournament& tournament, size_t user, size_t id);
