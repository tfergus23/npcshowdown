...
After a tournament runs, you can compare trainer performance using stats like ELO, win/loss records, and biggest upsets.
![tournament-results](images/tournament-results.png)
## Development
